...
if __name__ == "__main__":
    ...
    for i in tqdm(final_urls):
        ...
        try:
            ...
            news_date - re.sub(pattern=pattern1, repl='', strint=str(news_date))
            
        news_dates.append(news_date)
            
        
    news_df = pd.DataFrame({'date':news_dates, 'title': news_title, 'link': final_urls, 'content':news_contents})
